...
class Cryptobox extends events_1.default {
    constructor(engine, minimumAmountOfPreKeys = 1) {
        ...
        const storageEngine = engine.constructor.name;
    ...
    get_prekey_bundle(preKeyId = proteus_1.keys.PreKey.MAX_PREKEY_ID) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return proteus_1.keys.PreKeyBundle.new(this.identity.public_key, preKey);
        });
    }
    ...
    session_from_message(session_id, envelope) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.identity) {
                ...
                const cryptoBoxSession = new CryptoboxSession_1.CryptoboxSession(session_id, session);
    ...
    session_load(session_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.identity) {
                const session = yield this.store.read_session(this.identity, session_id);
                const cryptobox_session = new CryptoboxSession_1.CryptoboxSession(session_id, session);
