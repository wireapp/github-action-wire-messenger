...
describe('AssetService', () => {
    ...
    describe('"uploadImageAsset"', () => {
        it('builds an encrypted asset payload', () => __awaiter(void 0, void 0, void 0, function* () {
            const assetServerData = {
                key: `3-2-${new pure_uuid_1.default(4).format()}`,
                keyBytes: Buffer.from(new pure_uuid_1.default(4).format()),
                sha256: new pure_uuid_1.default(4).format(),
                token: new pure_uuid_1.default(4).format(),
            };
            ...
            const asset = yield assetService.uploadImageAsset(image);
