...
describe('Account', () => {
    ...
    beforeEach(() => {
        ...
        nock(MOCK_BACKEND.rest)
            .post(`${auth_1.AuthAPI.URL.ACCESS}/${auth_1.AuthAPI.URL.LOGOUT}`)
            .reply(http_1.StatusCode.OK, undefined);
        nock(MOCK_BACKEND.rest)
            .post(auth_1.AuthAPI.URL.ACCESS)
            .reply(http_1.StatusCode.OK, accessTokenData);
        nock(MOCK_BACKEND.rest)
            .post(client_1.ClientAPI.URL.CLIENTS)
