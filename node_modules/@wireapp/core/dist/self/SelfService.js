...
class SelfService {
    ...
    checkUsername(username) {
        return __awaiter(this, void 0, void 0, function* () {
            const [availableUsername] = yield this.checkUsernames([username]);
    ...
    getName() {
        return __awaiter(this, void 0, void 0, function* () {
            const { name } = yield this.apiClient.self.api.getName();
            return name;
        });
    }
    getSelf() {
    ...
    getUsername() {
        return __awaiter(this, void 0, void 0, function* () {
            const { handle } = yield this.apiClient.self.api.getSelf();
            return handle;
        });
    }
    setName(name) {
