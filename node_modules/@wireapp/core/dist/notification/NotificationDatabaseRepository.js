...
class NotificationDatabaseRepository {
    ...
    getLastEventDate() {
        return __awaiter(this, void 0, void 0, function* () {
            const { value } = yield this.storeEngine.read(STORE_AMPLIFY, DatabaseKeys.PRIMARY_KEY_LAST_EVENT);
            return new Date(value);
        });
    }
    updateLastEventDate(eventDate) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.storeEngine.update(STORE_AMPLIFY, DatabaseKeys.PRIMARY_KEY_LAST_EVENT, { value: eventDate.toISOString() });
            return eventDate;
        });
    }
    createLastEventDate(eventDate) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.storeEngine.create(STORE_AMPLIFY, DatabaseKeys.PRIMARY_KEY_LAST_EVENT, { value: eventDate.toISOString() });
            return eventDate;
        });
    }
    getLastNotificationId() {
        return __awaiter(this, void 0, void 0, function* () {
            const { value } = yield this.storeEngine.read(STORE_AMPLIFY, DatabaseKeys.PRIMARY_KEY_LAST_NOTIFICATION);
            return value;
        });
    }
    updateLastNotificationId(lastNotification) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.storeEngine.updateOrCreate(STORE_AMPLIFY, DatabaseKeys.PRIMARY_KEY_LAST_NOTIFICATION, {
