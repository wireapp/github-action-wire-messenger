import type { ConversationAccessUpdateData, ConversationCodeUpdateData, ConversationConnectRequestData, ConversationCreateData, ConversationMemberJoinData, ConversationMemberLeaveData, ConversationMemberUpdateData, ConversationMessageTimerUpdateData, ConversationOtrMessageAddData, ConversationReceiptModeUpdateData, ConversationRenameData, ConversationTypingData } from '../conversation/data/';
import { QualifiedId } from '../user';
export declare enum CONVERSATION_EVENT {
...
export declare type ConversationEventData = ConversationAccessUpdateData | ConversationCodeUpdateData | ConversationConnectRequestData | ConversationCreateData | ConversationMemberJoinData | ConversationMemberLeaveData | ConversationMemberUpdateData | ConversationMessageTimerUpdateData | ConversationOtrMessageAddData | ConversationReceiptModeUpdateData | ConversationRenameData | ConversationTypingData | null;
export declare type ConversationEvent = ConversationAccessUpdateEvent | ConversationCodeDeleteEvent | ConversationConnectRequestEvent | ConversationCreateEvent | ConversationDeleteEvent | ConversationMemberJoinEvent | ConversationMemberLeaveEvent | ConversationMemberUpdateEvent | ConversationMessageTimerUpdateEvent | ConversationOtrMessageAddEvent | ConversationReceiptModeUpdateEvent | ConversationRenameEvent | ConversationTypingEvent;
