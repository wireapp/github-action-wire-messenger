import type { UserActivateData, UserClientAddData, UserClientRemoveData, UserConnectionData, UserDeleteData, UserLegalHoldDisableData, UserLegalHoldEnableData, UserLegalHoldRequestData, UserPropertiesSetData, UserPushRemoveData, UserUpdateData } from '../user/data';
...
export declare type UserEventData = UserActivateData | UserClientAddData | UserLegalHoldRequestData | UserLegalHoldEnableData | UserLegalHoldDisableData | UserClientRemoveData | UserConnectionData | UserDeleteData | UserPropertiesSetData | UserUpdateData | UserPushRemoveData | null;
export declare type UserEvent = UserActivateEvent | UserClientAddEvent | UserLegalHoldRequestEvent | UserLegalHoldEnableEvent | UserLegalHoldDisableEvent | UserClientRemoveEvent | UserConnectionEvent | UserDeleteEvent | UserPropertiesSetEvent | UserUpdateEvent | UserPushRemoveEvent;
