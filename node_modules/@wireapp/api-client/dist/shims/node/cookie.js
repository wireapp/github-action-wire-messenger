...
const logger = logdown_1.default('@wireapp/api-client/shims/node/cookie', {
    logger: console,
    markdown: false,
});
exports.retrieveCookie = (response) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
 ...
 */
exports.sendRequestWithCookie = (client, config) => __awaiter(void 0, void 0, void 0, function* () {
