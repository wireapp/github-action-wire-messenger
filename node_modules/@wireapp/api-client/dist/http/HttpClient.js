...
class HttpClient extends events_1.default {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (response) {
                    ...
                    const isBackendError = ((_a = errorData) === null || _a === void 0 ? void 0 : _a.code) && ((_b = errorData) === null || _b === void 0 ? void 0 : _b.label) && ((_c = errorData) === null || _c === void 0 ? void 0 : _c.message);
                    if (isBackendError) {
                        error = http_1.BackendErrorMapper.map(errorData);
                    }
                    else {
                        const isUnauthorized = errorStatus === http_1.StatusCode.UNAUTHORIZED;
                        const hasAccessToken = !!((_d = this.accessTokenStore) === null || _d === void 0 ? void 0 : _d.accessToken);
    ...
    postAccess(expiredAccessToken) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((_a = expiredAccessToken) === null || _a === void 0 ? void 0 : _a.access_token) {
