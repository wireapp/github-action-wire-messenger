...
import { AccessTokenData, AccessTokenStore } from '../auth/';
import { ConnectionState } from '../http/';
declare enum TOPIC {
...
export declare class HttpClient extends EventEmitter {
    ...
    _sendRequest<T>(config: AxiosRequestConfig, tokenAsParam?: boolean, firstTry?: boolean): Promise<AxiosResponse<T>>;
    ...
    sendXML<T>(config: AxiosRequestConfig, isSynchronousRequest?: boolean): Promise<AxiosResponse<T>>;
