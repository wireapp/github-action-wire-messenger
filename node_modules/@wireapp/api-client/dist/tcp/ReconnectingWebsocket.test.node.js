...
function startEchoServer() {
    ...
    const server = new ws_1.Server({ port: PORT });
...
describe('ReconnectingWebsocket', () => {
    ...
    it('calls "onReconnect", "onOpen" and "onClose"', done => {
        ...
        const RWS = new ReconnectingWebsocket_1.ReconnectingWebsocket(onReconnect);
        RWS.setOnOpen(() => {
    ...
    it('sends ping messages', done => {
        const RWS = new ReconnectingWebsocket_1.ReconnectingWebsocket(() => getServerAddress(), { pingInterval: commons_1.TimeUtil.TimeInMillis.SECOND });
...
//# sourceMappingURL=ReconnectingWebsocket.test.node.js.map