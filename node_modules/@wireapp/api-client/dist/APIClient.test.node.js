...
describe('APIClient', () => {
    ...
    describe('"login"', () => {
        ...
        beforeEach(() => {
            ...
            nock_1.default(baseUrl)
                .post(`${AuthAPI_1.AuthAPI.URL.ACCESS}/${AuthAPI_1.AuthAPI.URL.LOGOUT}`)
                .reply(200, undefined);
        });
        ...
        it('refreshes an access token when it becomes invalid', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            nock_1.default(baseUrl)
                .get(UserAPI_1.UserAPI.URL.USERS)
            ...
            nock_1.default(baseUrl)
                ...
                .reply(200, userData);
            nock_1.default(baseUrl)
                .post(AuthAPI_1.AuthAPI.URL.ACCESS)
                .reply(200, accessTokenData);
            const client = new APIClient_1.APIClient();
            const context = yield client.login(loginData);
            expect(context.userId).toBe(accessTokenData.user);
            // Make access token invalid
            delete ((_b = client['accessTokenStore'].accessToken) === null || _b === void 0 ? void 0 : _b.access_token);
    ...
    describe('"register"', () => {
        ...
        beforeEach(() => {
            nock_1.default(baseUrl)
                .post(AuthAPI_1.AuthAPI.URL.REGISTER, registerData)
