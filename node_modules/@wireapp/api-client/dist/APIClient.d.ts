...
import { TeamConversationAPI, FeatureAPI, IdentityProviderAPI, LegalHoldAPI, MemberAPI, PaymentAPI, ServiceAPI, TeamAPI, TeamInvitationAPI } from './team/';
...
export declare class APIClient extends EventEmitter {
    ...
    config: Config;
    static BACKEND: {
        PRODUCTION: import("./env").BackendData;
        STAGING: import("./env").BackendData;
    };
    ...
    connect(onBeforeConnect?: () => Promise<void>): Promise<WebSocketClient>;
