...
exports.updateSpec = {
    'fails if the record does not exist.': (engine) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            yield engine.update(TABLE_NAME, PRIMARY_KEY, updates);
            fail();
        }
        catch (error) {
            expect(error).toEqual(jasmine.any(error_1.RecordNotFoundError));
        }
    }),
    'updates an existing database record.': (engine) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const primaryKey = yield engine.update(TABLE_NAME, PRIMARY_KEY, updates);
