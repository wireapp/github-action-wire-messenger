...
exports.deleteAllSpec = void 0;
const TABLE_NAME = 'the-simpsons';
exports.deleteAllSpec = {
    'deletes all records from a database table.': (engine) => __awaiter(void 0, void 0, void 0, function* () {
        const homer = {
            entity: {
                firstName: 'Homer',
                lastName: 'Simpson',
