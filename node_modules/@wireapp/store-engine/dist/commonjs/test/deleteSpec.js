...
exports.deleteSpec = void 0;
const TABLE_NAME = 'the-simpsons';
exports.deleteSpec = {
    'deletes a record.': (engine) => __awaiter(void 0, void 0, void 0, function* () {
        const homer = {
            entity: {
                firstName: 'Homer',
                lastName: 'Simpson',
        ...
        yield engine.delete(TABLE_NAME, lisa.primaryKey);
    ...
    'returns the primary key of a deleted record.': (engine) => __awaiter(void 0, void 0, void 0, function* () {
        const PRIMARY_KEY = 'primary-key';
        const entity = {
            some: 'value',
        };
        const primaryKey = yield engine.create(TABLE_NAME, PRIMARY_KEY, entity);
        const deletedKey = yield engine.delete(TABLE_NAME, primaryKey);
        expect(deletedKey).toBe(PRIMARY_KEY);
    }),
};
//# sourceMappingURL=deleteSpec.js.map